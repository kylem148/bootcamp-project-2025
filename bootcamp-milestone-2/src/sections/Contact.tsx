...
const Contact = () => {
  return (
    <div className="grid mt-20 md:mt-50 lg:grid-cols-2 items-start gap-16 p-6 mx-auto max-w-5xl max-lg:max-w-2xl bg-neutral-700 border-6 border-gray-600 rounded-2xl">
      <div>
