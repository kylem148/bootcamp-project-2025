  ...
  return (
    <div id="contact" className="grid mt-20 md:mt-50 lg:grid-cols-2 items-start gap-16 p-6 mx-auto max-w-5xl max-lg:max-w-2xl bg-neutral-700 border-6 border-neutral-800 rounded-2xl scroll-mt-20">
      ...
      <form className="lg:ml-auto space-y-4">
        ...
        <button type='button'
          className="text-white bg-neutral-900 hover:bg-neutral-800 tracking-wide rounded-md text-sm font-medium px-4 py-3 w-full cursor-pointer !mt-2 border-0">Send message</button>
      </form>
    </div>
  )
}
