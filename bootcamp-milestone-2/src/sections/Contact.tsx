...
const Contact = () => {
  return (
    <div id="contact" className="grid mt-20 md:mt-50 lg:grid-cols-2 items-start gap-16 p-6 mx-auto max-w-5xl max-lg:max-w-2xl bg-neutral-700 border-6 border-gray-600 rounded-2xl scroll-mt-20">
      <div>
          ...
          <ul className="mt-4">
            <li className="flex items-center">
              ...
              <a href="javascript:void(0)" className="text-sm ml-4">
                ...
                <span className="font-semibold text-green-300">kyle@themorganization.com</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <form className="lg:ml-auto space-y-4">
        ...
        <textarea placeholder='Message'
          className="w-full rounded-md px-4 bg-slate-100 text-slate-900 text-sm pt-3 border border-gray-200 focus:border-slate-900 outline-none "></textarea>
        <button type='button'
